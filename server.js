...
app.post('/api/consulta-rag', async (req, res) => {
  ...
  } catch (e) { console.error(e); res.status(500).json({ error: 'Erro RAG' }); }
});

// ============== ROTAS 100% CORRETAS (usando -> id) ==============
...
// CONTAS (com Cliente/Fornecedor/Faturado + nome)
...
app.listen(port, () => {
  console.log(`SERVIDOR 100% FUNCIONAL - ID CARREGA EM TODAS AS TELAS`);
